      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        <ScrollReveal className="mb-24 md:mb-32">
          ...
          <div className="flex items-center gap-4 reveal-text">
            ...
            <p className="text-white/40 uppercase tracking-[0.4em] text-[10px] md:text-xs font-black italic">Official EA Sports FC Challenger</p>
          </div>
        </ScrollReveal>
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              <div className="space-y-8">
                <div className="flex justify-between items-start">
                  <h3 className="text-[clamp(2rem,5vw,4rem)] font-black font-heavy tracking-tighter text-left uppercase">FC MOBILE</h3>
                ...
                <div className="space-y-8 mb-8">
                  <div className="flex flex-col">
                    <span className="text-[10px] md:text-xs font-black uppercase tracking-[0.5em] text-blood mb-2">IDENTIFICATION</span>
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[clamp(1.5rem,5vw,3.5rem)] font-black font-heavy tracking-tighter uppercase text-white/60 leading-none">FC CHAMPION 50</span>
                  </div>
                </div>

                <p className="text-[clamp(1rem,1.8vw,1.5rem)] text-white font-black leading-tight italic max-w-xl">
                  Precision football management and on-pitch execution at the highest tactical levels.
                </p>
              </div>
              ...
              <div className="aspect-square relative overflow-hidden rounded-[2rem] grayscale group-hover:grayscale-0 transition-all duration-700 w-full max-w-md mx-auto lg:mx-0">
                 <img 
                  src="https://picsum.photos/seed/ea-fc/1000/1000" 
                  alt="FC Mobile Emblem"
                  className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-1000"
                />
                
                <div className="absolute inset-0 bg-premium-black/40 flex flex-col items-center justify-center">
                  <div className="p-6 md:p-12 border-2 md:border-4 border-white/20 backdrop-blur-md rounded-full group-hover:border-blood transition-colors">
                    <Gamepad2 className="w-16 md:w-32 h-16 md:h-32 text-white group-hover:text-blood transition-all duration-500" />
                  </div>
                </div>
              </div>
            </div>
